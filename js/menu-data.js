    ...
    menuItems: [
      {
        ...
        shortcut: 'Ctrl+N',
        enabled: true,
        handler: () => console.log('新建(N) menu clicked!')
      }, 
      {
        title: '打开(O)...',
        shortcut: 'Ctrl+O',
      ...
      }, 
      {
        ...
        shortcut: 'Ctrl+S',
        enabled: true,
        handler: () => console.log('保存(S) menu clicked!')
      }, 
      {
        title: '另存为(A)...',
        shortcut: '',
        enabled: true,
        handler: () => console.log('另存为(A)... menu clicked!')
      }, 
      {
        title: 'hr',
        shortcut: '',
      ...
      }, 
      {
        ...
        shortcut: '',
        enabled: true,
        handler: () => console.log('页面设置(U)... menu clicked!')
      }, 
      {
        title: '打印(P)...',
        shortcut: 'Ctrl+P',
        enabled: true,
        handler: () => console.log('打印(P)... menu clicked!')
      }, 
      {
        title: 'hr',
        shortcut: '',
  ...
  }, 
  {
    ...
    menuItems: [
      ...
      }, 
      {
        ...
        shortcut: 'Ctrl+E',
        enabled: true,
        handler: function() { console.log('使用Bing搜索... menu clicked!'); }
      }, 
      {
        title: '查找(F)...',
        shortcut: 'Ctrl+F',
